...
class Evenement
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EvenementBundle\Entity\groupe",inversedBy="Evenement")
     ...
     * Set groupe
     *
     * @param \EvenementBundle\Entity\groupe $groupe
     *
     * @return Evenement
     */
    public function setGroupe(\EvenementBundle\Entity\groupe $groupe = null)
    {
        $this->groupe = $groupe;
